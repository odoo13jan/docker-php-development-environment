...
class UsersController extends Controller
{
    ...
    */
    ...
    public function create(Request $request)
    {
        ...
        // Fetch branches that match the user's branches directly, avoiding unnecessary loops
        $userBranches = UserBranch::with('branch')  // Eager loading related branch data
        ...
        // Prepare branches data to send to the view
        $branches = $userBranches->map(function ($userBranch) {
            return [
