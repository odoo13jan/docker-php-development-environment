...
<div class="card card-primary card-outline">
  ...
  <div class="card-body">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-12 text-center">
                    <a class="btn btn-success" href="{{route('admin.antibiotics.export')}}">
                      <i class="fa fa-file-excel"></i>
                      {{__('Export')}}
                    </a>
                    <a class="btn btn-success" href="{{route('admin.antibiotics.download_template')}}">
                      <i class="fa fa-file-excel"></i>
                  ...
                  <div class="col-lg-12">
                    <!-- import form -->
                    <form action="{{route('admin.antibiotics.import')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="row mt-3">
                        <div class="col-lg-12">
                          <div class="card card-primary card-outline">
    ...
    <div class="row table-responsive">
      <div class="col-12">
        <table id="antibiotics_table" class="table table-striped table-bordered"  width="100%">
          <thead>
            <tr>
              <th width="10px">
...
@section('scripts')
  <script>
    var can_delete=@can('delete_antibiotic')true @else false @endcan
  </script>
