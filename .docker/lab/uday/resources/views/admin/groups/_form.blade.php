                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select id="phone_select" name="patient_id" class="form-control" required>
                                @if(isset($group) && isset($group['patient']))
                                    <option value="{{$group['patient']['id']}}" selected>{{$group['patient']['phone']}}</option>
                                @endif
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control flatpickr" name="sample_collection_date" id="sample_collection_date" @if(isset($group)) value="{{$group['sample_collection_date']}}" @else value="{{get_system_date('','o-m-d H:i:s a')}}" @endif>
                        </div> 
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label>{{__('C Date')}}</label>
                    
                            <input type="text" class="form-control flatpickr" name="created_at" id="created_at" @if(isset($group)) value="{{$group['created_at']}}" @else value="{{get_system_date()}}" @endif>
                        </div> 
                    </div>
                </div>
            </div>
                                ...
                                @if(isset($group))
                                    ...
                                    <tr>
                                        ...
                                        <td>  
                                            ...
                                            <span class="error-message" style="display:none; color:red;">Please select a payment method.</span>
                                        </td>
