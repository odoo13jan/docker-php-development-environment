...
<div class="card card-primary card-outline">
            ...
            <table id="groups_table" class="table table-striped table-bordered" width="100%">
               <thead>
                <tr>
                  ...
                  <th width="150px">{{__('Doctor')}}</th>
                  <th width="100px">{{__('Contract')}}</th>
                  <th width="50px">{{__('Subtotal')}}</th>
                  <th width="50px">{{__('Discount')}}</th>
                  <th width="50px">{{__('Total')}}</th>
                  <th width="50px">{{__('Paid')}}</th>
                  <th width="50px">{{__('Due')}}</th>
              ...
              <!--</tfoot>-->
              <tfoot>
    <!-- Line 1: Single footer row with rich styling, spanning all 16 columns -->
    ...
    <!-- Line 6: Financial metrics in a single row with grid layout -->
    <tr class="bg-light">
        <!-- Line 7: Subtotal metric -->
        <th colspan="3" class="border-right">
            <div class="d-flex align-items-center">
                <i class="fas fa-dollar-sign text-primary mr-2"></i>
                <span>{{__('Subtotal')}}:</span>
                <span id="summary_subtotal" class="text-primary ml-auto font-weight-bold"></span>
            </div>
        </th>
        <!-- Line 13: Discount metric -->
        <th colspan="3" class="border-right">
            <div class="d-flex align-items-center">
                <i class="fas fa-percentage text-warning mr-2"></i>
                <span>{{__('Discount')}}:</span>
                <span id="summary_discount" class="text-warning ml-auto font-weight-bold"></span>
            </div>
        </th>
        <!-- Line 19: Total metric -->
        <th colspan="3" class="border-right">
            <div class="d-flex align-items-center">
                <i class="fas fa-file-invoice-dollar text-info mr-2"></i>
                <span>{{__('Total')}}:</span>
                <span id="summary_total" class="text-info ml-auto font-weight-bold"></span>
            </div>
        </th>
        <!-- Line 25: Paid metric -->
        <th colspan="3" class="border-right">
            <div class="d-flex align-items-center">
                ...
                <span>{{__('Paid')}}:</span>
                <span id="summary_paid" class="text-success ml-auto font-weight-bold"></span>
            </div>
        </th>
        <!-- Line 31: Due metric -->
        <th colspan="4">
            <div class="d-flex align-items-center">
                ...
                <span>{{__('Due')}}:</span>
                <span id="summary_due" class="text-danger ml-auto font-weight-bold"></span>
            </div>
        </th>
    </tr>
</tfoot>
