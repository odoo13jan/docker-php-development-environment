    ...
    <div class="card-footer">
        ...
        <div class="row no-print">
            <div class="col-12">
                ...
                <a target="_blank" href="{{route('admin.medical_reports.edit',$group['id'])}}" class="btn btn-info">
                    <i class="fa fa-file-pdf"></i> {{__('Edit Report')}}
                </a>
                ...
                @if($whatsapp['receipt']['active']&&isset($group['receipt_pdf']))
                    ...
                    @endphp
                    <a target="_blank" href="https://wa.me/+91{{$group['patient']['phone']}}?text={{$message}}" class="btn btn-success">
