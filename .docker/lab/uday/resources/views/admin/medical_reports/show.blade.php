...
<form method="POST" action="{{route('admin.medical_reports.pdf',$group['id'])}}" id="print_form">
    ...
    <div class="row mb-3">
        ...
        <div class="col-lg-6">
            <button type="submit" class="btn btn-warning float-right d-inline mr-2" formaction="{{route('admin.medical_reports.pdf', [$group['id'], 'no_header_footer' => 1])}}">
            <i class="fa fa-print"></i>
            {{__('Print without Header/Footer')}}
        </button>
