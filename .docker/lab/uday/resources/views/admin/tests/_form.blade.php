        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                ...
                <ul class="list-style-none">
                    ...
                    <li class="d-inline float-right mr-1">
                        <button type="button" class="btn btn-primary btn-sm  add_ref_temp">
                            <i class="fa fa-plus"></i>
                            {{__('Ref Template')}}
                        </button>
                    </li>
                                            ...
                                            @if($component['title'])
                                                ...
                                                <td>
                                                    <div class="form-group no">
                                                        <input type="text"  class="form-control" name="component[{{$count}}][id]" value="{{$component['id']}}">
                                                    </div>
                                                </td>
                                                @if($component['title'] and !$component['result_temp'] )
                                                <td colspan="2">
                                                    <div class="form-group">
                                                ...
                                                @if($component['result_temp'])
                                                <td colspan="5">
                                                    <div class="form-group">
                                                        <textarea name="component[{{$count}}][result_temp]" class="form-control " >{{$component['result_temp']}}</textarea>
                                                    </div>
                                                </td>
                                                @endif
                                                    ...
                                                    <table class="table table-bordered reference_range">
                                                        <thead>
                                                            <tr>
                                                              ...
                                                              <th class="age text-center">{{__('Age')}}</th>
                                                        ...
                                                        <tbody>
                                                            @foreach($component['reference_ranges'] as $reference_range)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <input type="text" name="component[{{$count}}][reference_ranges][{{$count_reference_ranges}}][age_from]" class="form-control" value="{{$reference_range['age_from']}}" required>:
                                                                        <input type="texttext" name="component[{{$count}}][reference_ranges][{{$count_reference_ranges}}][age_to]" class="form-control" value="{{$reference_range['age_to']}}" required>
                                                                    </td>
                                                                    <td class="text-center">
