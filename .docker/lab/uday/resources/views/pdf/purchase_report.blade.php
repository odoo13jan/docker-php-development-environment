@extends('layouts.pdf')
@section('title')
    {{__('Purchases report')}}-{{date('Y-m-d')}}
@endsection
@section('content')
<style>
    .title{
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <th width="2px" align="center">{{__('Supplier')}}</th>
            <th width="2px" align="center">{{__('Branch')}}</th>
            <th>{{__('Date')}}</th>
            <th>{{__('Total')}}</th>
            <th>{{__('Paid')}}</th>
            <th>{{__('Due')}}</th>
        ...
        <tr>
            ...
            <td align="center">{{$purchase['supplier']['name']}}</td>
            <td align="center">{{$purchase['branch']['name']}}</td>
            <td align="center">
                {{$purchase['date']}}
            </td>
          ...
          <tbody>
            ...
            @foreach($data['payments'] as $payment)
                <tr>
                    ...
                    <td align="center" width="2px">{{$payment['purchase']['supplier']['name']}}</td>
